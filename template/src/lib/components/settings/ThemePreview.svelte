...
>
	...
	<div class="card bg-surface-secondary/30!">
		...
		<div class="flex flex-col gap-4">
			<div class="flex items-start justify-between gap-3">
				...
				<div
					class="bg-accent text-on-accent flex size-9 shrink-0 items-center justify-center rounded-xl text-sm font-bold"
				>
					$
				</div>
			</div>
	...
	<!-- Form Controls -->
	<div class="card bg-surface-secondary/30!">
		<p class="text-tertiary mb-3 text-[10px] font-bold tracking-widest uppercase">
			Form Controls
		</p>
		<div class="mb-3 grid grid-cols-2 gap-3">
			<div class="form-group">
				<label for="pv-name">Full name *</label>
				<input id="pv-name" type="text" placeholder="Alex Bennett" />
			</div>
			<div class="form-group">
			...
			<div class="flex flex-wrap gap-x-5 gap-y-2">
				<label
					...
					style="text-transform:none;letter-spacing:normal;color:var(--text-primary)"
				>
